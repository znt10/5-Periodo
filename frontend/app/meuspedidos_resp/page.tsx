    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#0d1117]">
      ...
      <main className="flex-1 p-4 md:p-10 lg:ml-64 transition-all relative">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-6 md:gap-8 items-start">
            ...
            <aside className="w-full lg:w-72 bg-[#161b22] rounded-[24px] p-6 text-white shadow-xl border border-gray-800 sticky top-4">
                {/* ... conteúdo do filtro ... */}
                <h2 className="text-xl font-bold mb-6 text-gray-100 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>
                    Filtro
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-5">
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Status</label>
                        <select className="w-full bg-[#0d1117] border border-gray-800 rounded-xl py-3 px-4 text-sm text-gray-300 outline-none focus:border-blue-500">
                            <option>Todos</option>
                            <option>Entregue</option>
                            <option>Pendente</option>
                        </select>
                    </div>
                    <button className="w-full mt-2 bg-blue-600 hover:bg-blue-700 py-3.5 rounded-xl font-bold text-white transition-all active:scale-95 shadow-lg shadow-blue-900/20">
                        Confirmar
                    </button>
                </div>
            </aside>
