...
export default function PedidosUnidade() {
  ...
  const todosPedidos = [
    ...
    {
      id: 4,
      img: "/images/minicoxinhas.jpg",
      data: "15/03/26",
      produto: "Mini Coxinhas",
      qtd: 1000,
      desc: "Encomenda especial para o evento de final de semana na unidade lapa",
      status: "Entregue",
    },
    {
      id: 5,
      img: "/images/minienroladinhos.jpg",
      data: "15/03/26",
      produto: "Mini Salsicha",
      qtd: 500,
      desc: "Reposição urgente de estoque devido à alta demanda",
      status: "Entregue",
    },
    {
      id: 6,
      img: "/images/minipastel.jpg",
      data: "15/03/26",
      produto: "Mini Pastel",
      qtd: 500,
      desc: "Encomenda final de semana",
      status: "Entregue",
    },
    {
      id: 7,
      ...
      produto: "Óleo",
      qtd: 10,
      desc: "Falta estoque no depósito central",
      status: "Entregue",
    },
  ];
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen dark:bg-[#0a0f1c] font-sans antialiased">
      <Sidebar />
        ...
        <div className="flex justify-between items-start mb-10">
          <header>
            ...
            <p className="text-gray-500 text-sm font-medium mt-3">
              Mostrando {inicio + 1}-{Math.min(fim, todosPedidos.length)} de{" "}
              {todosPedidos.length} pedidos
            </p>
          </header>
          <Link
            href="/gerencia"
            className="bg-[#161b22] border border-gray-800 px-5 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-widest text-gray-400 hover:text-white hover:bg-[#1f262e] transition-all flex items-center gap-2"
          >
              ...
              <table className="w-full text-left border-collapse min-w-[700px]">
                <thead>
                  <tr className="border-b border-gray-800/60">
                    <th className="px-8 py-5 text-[10px] font-black text-gray-600 uppercase tracking-[2px] text-center">
                      Ícone
                    </th>
                    ...
                    <th className="px-6 py-5 text-[10px] font-black text-gray-600 uppercase tracking-[2px] text-center">
                      Qtd
                    </th>
                    <th className="px-6 py-5 text-[10px] font-black text-gray-600 uppercase tracking-[2px]">
                      Descrição
                ...
                <tbody className="divide-y divide-gray-800/40">
                  {pedidosExibidos.map((item) => (
                    <tr
                      key={item.id}
                      className="hover:bg-[#1f262e]/50 transition-colors group"
                    >
                      <td className="px-8 py-5">
                        <div className="flex justify-center">
                          <img
                            src={item.img}
                            alt={item.produto}
                            className="w-12 h-12 rounded-2xl border border-gray-800 object-cover shadow-lg group-hover:scale-110 transition-transform"
                          />
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-5 text-base font-black text-white tracking-tight">
                        {item.produto}
                      </td>
                      <td className="px-6 py-5 text-center font-black text-blue-500 text-base">
                        {item.qtd}
                      </td>
          ...
          <aside className="w-full lg:w-80 bg-[#161b22] border border-gray-800 rounded-[32px] p-8 shadow-2xl">
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <label className="text-[10px] font-black text-gray-600 uppercase tracking-[2px] ml-1">
                  Status
                </label>
              ...
              <div className="space-y-3">
                ...
                <input
                  type="date"
                  className="w-full bg-[#0d1117] border border-gray-800 rounded-2xl py-4 px-5 text-sm font-bold text-gray-300 outline-none focus:border-blue-500/50 [color-scheme:dark]"
                />
              </div>
