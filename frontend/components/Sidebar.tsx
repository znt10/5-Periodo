  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/registrar">
          <div
            className={`flex items-center gap-3 px-6 py-6 text-slate-300 overflow-hidden ${isCollapsed ? "justify-center px-0" : ""}`}
          >
        ...
        <div className="w-full border-t border-slate-800/50 p-4 bg-[#080b11]">
          <ul
            className={`mb-4 space-y-1 ${isCollapsed ? "flex flex-col items-center" : ""}`}
          >
            {/* ITEM NOTIFICAÇÕES */}
            <li>
              <Link
            ...
            <li>
              <button
                ...
                className={`flex w-full items-center gap-3 cursor-pointer text-[14px] text-slate-400 hover:text-white transition-colors px-3 py-2.5 rounded-lg hover:bg-red-500/10 ${isCollapsed ? "justify-center" : ""}`}
              >
