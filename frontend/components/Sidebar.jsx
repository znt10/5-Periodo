      ...
      `}>
        ...
        <div className="w-full border-t border-slate-800/50 p-4 bg-[#080b11]">
          <ul className={`mb-4 space-y-1 ${isCollapsed ? 'flex flex-col items-center' : ''}`}>
            ...
            {/* ITEM NOTIFICAÇÕES (AGORA AQUI EM BAIXO) */}
            <li>
            ...
            {/* Configurações */}
            <li className={`flex items-center gap-3 cursor-pointer text-[14px] text-slate-300 hover:text-white transition-colors px-3 py-2.5 rounded-lg hover:bg-slate-800/40 ${isCollapsed ? 'justify-center' : ''}`}>
              <Icons.Settings /> {!isCollapsed && "Configurações"}
            </li>
